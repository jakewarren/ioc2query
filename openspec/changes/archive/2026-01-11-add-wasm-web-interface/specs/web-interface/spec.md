...
## Purpose
Provides a browser-based interface for running ioc2query without installation. Compiles the CLI to WebAssembly and exposes functionality through a single-page web application deployed via GitHub Pages.
